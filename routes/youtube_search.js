...
const YOUTUBE_API_KEY = 'AIzaSyDmNNPHpcbCkFFjKD7nuMFfMo63aohQN8k';
...
// 
// 		// Downloading ,Converting mp4 youtube video using video_id 
// 		// const ytdl = exec(`youtube-dl -o - best --recode-video mp4 -a - http://www.youtube.com/watch?v=${vid}`, (err, stdout, stderr) => {
// 		// 		// console.log("STDOUT: " + stdout);
// 		// 		// stdout.pipe(res).on('error',(err)=>next(err));
// 		// })
// 		const ytdl = exec(`youtube-dl --version`, (err, stdout, stderr) => {
// 				console.log("STDOUT: " + stdout);
// 				// stdout.pipe(res).on('error',(err)=>next(err));
// 		})
// 		// console.log(ytdl.stdout);
// 		
// 		// Setting output pipe first so that we dont lose any bits
// 		// ytdl.stdout.pipe(res).on('error',(err)=>next(err));
// 
